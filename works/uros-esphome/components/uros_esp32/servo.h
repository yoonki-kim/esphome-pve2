...
#define SERVO_S1_DEF_ANGLE (0)   // S1 default angle
#define SERVO_S1_MIN_ANGLE (-90) // Limit S1 minimum angle
#define SERVO_S1_MAX_ANGLE (90)  // Limit S1 maximum angle

#define SERVO_S2_DEF_ANGLE (-60) // S2 default angle
#define SERVO_S2_MIN_ANGLE (-90) // Limit S2 minimum angle
#define SERVO_S2_MAX_ANGLE (20)  // Limit S2 maximum angle
