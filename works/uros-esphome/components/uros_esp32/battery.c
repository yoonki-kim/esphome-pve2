...
static void Battery_Task(void *arg)
{
    ...
    // Deregister ADC before ending the task
...
void Battery_Init(void)
{
    ...
    // Enable the battery voltage reading task
